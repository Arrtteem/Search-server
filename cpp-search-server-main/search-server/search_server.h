...
public:
    ...
    std::vector<Document> FindTopDocuments(const string& raw_query,
    ...
    std::vector<Document> FindTopDocuments(const string& raw_query, DocumentStatus status) const;
...
private:
    ...
    std::vector<string> SplitIntoWordsNoStop(const std::string& text) const;
